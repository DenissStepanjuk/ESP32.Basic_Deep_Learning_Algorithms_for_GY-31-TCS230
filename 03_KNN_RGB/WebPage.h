...
"    <head>"
"      <meta charset='UTF-8'>"
"      <title>ESP32 GY-31 TCS230 (Color Sensor)</title>"
 /** TABLE **//////////////////////////////////////////////////////////////////////////////////////////////////////
"  <style>"
"    table {"
...
"      <div>Color from Sensor: </div>"

      /** Кнопки:
        - DETECT - Захватить параметры цвета с датчика и добавить в датасет.
        - DOWNLOAD - Скачать датасет.**/
"      <p><button type='button' id='BTN_Detect'> DETECT </button> <button onclick='location.reload();'>REFRESH PAGE</button></p>"


/** TABLE **//////////////////////////////////////////////////////////////////////////////////////////////////////
// Таблица с параметрами захвачеными с датчика, предсказанием цвета, а также списком ближайших соседей.
"      <div id='table-container'></div>"

/** TABLE **//////////////////////////////////////////////////////////////////////////////////////////////////////

"      <p>Стандартизируем признаки, удалив из признака среднее значение μ<sub>i</sub> и разделив на стандартное отклонение σ<sub>i</sub>.</p>"
"      <p><b>x<sub>i</sub><sup>new</sup> = (x<sub>i</sub> − μ<sub>i</sub>) / σ<sub>i</sub></b></p>"
"      <p>μ<sub>i</sub> — среднее значение (<strong>std_scaler.mean_</strong>)</p>"
"      <p><b>μ<sub>i</sub> = (1 / n) ∑<sub>j=1</sub><sup>n</sup> x<sub>ij</sub></b></p>"
"      <ul>"
"           <li><b>x<sub>ij</sub></b> — значение признака i у объекта j</li>"
"           <li><b>n</b> — количество объектов</li>"
"      </ul>"
"      <p>σ<sub>i</sub> — стандартное отклонение (<strong>std_scaler.scale_</strong>)</p>"
"      <p><b>σ<sub>i</sub> = √((1 / (n − 1)) ∑<sub>j=1</sub><sup>n</sup> (x<sub>ij</sub> − μ<sub>i</sub>)²)</b></p>"
"      <ul>"
"           <li><b>x<sub>ij</sub></b> — значение признака i у объекта j</li>"
"           <li><b>μ<sub>i</sub></b> — среднее значение признака i</li>"
"           <li><b>n</b> — количество объектов</li>"
"      </ul>"
...
"            }"
// Заполним таблицу с параметрами захвачеными с датчика, предсказанием цвета, а также списком ближайших соседей.
