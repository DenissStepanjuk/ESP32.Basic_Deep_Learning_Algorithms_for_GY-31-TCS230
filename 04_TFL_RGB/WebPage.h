...
"      <div>TensorFlowLite for GY-31 TCS230: </div>"
      /** Кнопки:
...
/** TABLE **//////////////////////////////////////////////////////////////////////////////////////////////////////
// Таблица с распределением вероятностей для каждого предсказываемого класса (цвета).
"      <div><b>Color from Sensor: </b></div>"
"      <div id='table-container-sensor'></div>"
// Таблица с параметрами захвачеными с датчика, а также предсказанием цвета на базе этих параметров.
